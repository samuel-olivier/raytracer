...
template<>
virtual void    UniformTexture<Color>::evaluateColor(float, float, Color &value) {value = _value; }

template<>
virtual void    UniformTexture<float>::evaluateFloat(float, float, float &value) {value = _value; }

template<>
virtual void    UniformTexture<QVector2D>::evaluateVec2(float, float, QVector2D &value) {value = _value; }
